...
const projects= [
    ...
    },
    {
        ...
        image: '',
        skills: ['React', 'React Router', 'SCSS', 'TypeScript', 'AWS s3'],
        overView: 'Your ultimate destination for all your camping needs! This website is a comprehensive conglomerate of campsite information from around the country, designed to provide campers with an easy-to-navigate and reliable platform for finding the perfect campsite for their outdoor adventures.',
